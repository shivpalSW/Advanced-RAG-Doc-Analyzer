...
class ModelLoader:
    ...
    def __init__(self):
        ...
        self._validate_env() # Validate environment variables
    ...
    def load_llm(self):
        """
        Load and return the LLM model.Load LLM dynamically based on provider in config.
        """
        ...
        # Get the LLM provider from environment variable or config
        provider_key = os.getenv("LLM_PROVIDER", "groq")  # Default groq
        # Check if the provider key exists in the config
